 ...
 * 
 * Customizer control that displays a dropdown of every BuddyPress Xprofile
 * field that is not restricted by member type.
 *
 * @package Jeremy
...
class Customize_XProfile_Control extends WP_Customize_Control {
	...
	/**
	 * Exclude certain field types from the results. If field_types is set, it
